...
public class EventObject4ServerMainStatusLocalSetOVPN  extends AbstractEventObjectStatusLocalSetZZZ implements IEventObject4ServerMainStatusLocalSetOVPN, Comparable<IEventObject4ServerMainStatusLocalSetOVPN>{
	 ...
	 */
	public EventObject4ServerMainStatusLocalSetOVPN(Object source, int iID,  String sStatusText, boolean bStatusValue) {
		super(source,iID,sStatusText,bStatusValue);		
	}
	
	public EventObject4ServerMainStatusLocalSetOVPN(Object source, int iID,  String sStatusAbbreviation, String sStatusText, boolean bStatusValue) {
		super(source,iID,sStatusText,bStatusValue);
		this.sStatusAbbreviation = sStatusAbbreviation;
	}
	
	public EventObject4ServerMainStatusLocalSetOVPN(Object source, int iID,  STATUSLOCAL objStatusEnum, boolean bStatusValue) {
   ...
   public boolean equals(Object aThat) {
     ...
     if (!(aThat instanceof EventObject4ServerMainStatusLocalSetOVPN)) return false;
     EventObject4ServerMainStatusLocalSetOVPN that = (EventObject4ServerMainStatusLocalSetOVPN)aThat;
