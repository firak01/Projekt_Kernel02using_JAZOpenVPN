 ...
 */
public class EventObject4VpnIpPingerStatusLocalOVPN  extends AbstractEventObjectStatusLocalZZZ implements IEventObject4VpnIpPingerStatusLocalOVPN{//FGL20251022: Das der abstrakten Klasse überlassen, Comparable<IEventObject4VpnIpPingerStatusLocalOVPN>{
	private static final long serialVersionUID = -8002352981706422081L;
	 ...
	 * @throws ExceptionZZZ 
	 */
	public EventObject4VpnIpPingerStatusLocalOVPN(Object source, int iID,  String sStatusText, boolean bStatusValue) throws ExceptionZZZ {
		super(source,sStatusText,bStatusValue);	
		EventObject4VpnIpPingerStatusLocal_(iID, null, null);
	}
	
	public EventObject4VpnIpPingerStatusLocalOVPN(Object source, int iID,  String sStatusAbbreviation, String sStatusText, boolean bStatusValue) throws ExceptionZZZ {
		super(source,sStatusText,bStatusValue);
		EventObject4VpnIpPingerStatusLocal_(iID, sStatusAbbreviation, null);
	}
	
	public EventObject4VpnIpPingerStatusLocalOVPN(Object source, int iID,  STATUSLOCAL objStatusEnum, boolean bStatusValue) throws ExceptionZZZ {
		super(source,"",bStatusValue);
		EventObject4VpnIpPingerStatusLocal_(iID, null, objStatusEnum);
	}
	
	private boolean EventObject4VpnIpPingerStatusLocal_(int iID, String sStatusAbbreviation, STATUSLOCAL objStatusEnum) throws ExceptionZZZ{		
		this.iID = iID;
