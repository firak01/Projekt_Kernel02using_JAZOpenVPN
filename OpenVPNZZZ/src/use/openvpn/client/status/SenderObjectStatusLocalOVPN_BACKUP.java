 ...
 *
 */
public class SenderObjectStatusLocalOVPN_BACKUP implements ISenderObjectStatusLocalOVPN,Serializable{
	 ...
	 */
	private ArrayListUniqueZZZ<IListenerObjectStatusLocalZZZ> listaLISTENER_REGISTERED = new ArrayListUniqueZZZ<IListenerObjectStatusLocalZZZ>();  //Das ist die Arrayliste, in welche  die registrierten Komponenten eingetragen werden 
																							  //wichtig: Sie muss private sein und kann nicht im Interace global definiert werden, weil es sonst nicht moeglich ist 
	
	
	public SenderObjectStatusLocalOVPN2() throws ExceptionZZZ{
		super();
	}
	...
	/* (non-Javadoc)
	 * @see basic.zKernel.status.ISenderObjectStatusBasicZZZ#getListenerRegisteredAll()
	 */
	@Override
	public final ArrayListUniqueZZZ<IListenerObjectStatusLocalZZZ> getListenerRegisteredAll() throws ExceptionZZZ{
