 ...
 *
 */
public class PanelDlgAdjustmentOVPN  extends KernelJPanelCascadedZZZ {
	/**
	 * DEFAULT Konstruktor, notwendig, damit man objClass.newInstance(); einfach machen kann.
	 *                                 
	 * lindhaueradmin, 23.07.2013
	 */
	public PanelDlgAdjustmentOVPN(){
		super();
	}
	public PanelDlgAdjustmentOVPN(IKernelZZZ objKernel, KernelJDialogExtendedZZZ dialogExtended) {
		super(objKernel, dialogExtended);
		String stemp; boolean btemp;
		try{
			//Diese Panel ist der Inhalt der Dialogbox
			...
			PanelAdjustementPointsOVPN panelPoints = new PanelAdjustementPointsOVPN(objKernel, dialogExtended);
			this.add(panelPoints, BorderLayout.SOUTH);	
			this.setPanelSub("CENTER", panelPoints);
